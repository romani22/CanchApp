...
import { JoinRequest, JoinRequestWithUser, RequestStatus } from '@/types/database.types';
...
export const getCreatorPendingRequests = async (
  userId: string
...
export const subscribeToRequests = (
  matchId: string,
  callback: (payload: { eventType: string; request: JoinRequest }) => void
) => {
  return supabase
