            ...
            >
                    ...
                    <View style={styles.sportsGrid}>
                        {sports.map((s) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.sportCard,
                                    sport === s.id && styles.sportCardActive
                                ]}
                            >
                                <MaterialCommunityIcons
                                    name={s.icon as any}
                                    size={28}
                                    color={sport === s.id ? colors.primary : colors.textPrimaryDark}
                                />
                                <Text style={[styles.sportLabel, sport === s.id && styles.sportLabelActive]}>
                                    {s.label}
                                </Text>
                            </TouchableOpacity>
                        ))}
                        ...
                        >
                            <View style={[styles.formatIconContainer, format === f.id && styles.formatIconActive]}>
                                <MaterialCommunityIcons
                                    name={f.icon as any}
                                    size={24}
                                    color={format === f.id ? colors.backgroundDark : colors.textPrimaryDark}
                                />
                            </View>
                            ...
                            <View style={[styles.radioOuter, format === f.id && styles.radioOuterActive]}>
                                {format === f.id && <View style={styles.radioInner} />}
                            </View>
                        </TouchableOpacity>
                    ))}
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.launchHint}>
                        Al lanzar el torneo, se notificará a los equipos cercanos y se abrirán las inscripciones.
                    </Text>
                    ...
                    <View style={styles.inputWrapper}>
                        ...
                        <TextInput
                            ...
                            placeholder="Ej. Club Olimpia, Cancha 1"
                            placeholderTextColor={colors.textSecondaryDark}
                            value={venue}
                ...
                <View style={styles.section}>
                    ...
                    <TextInput
                        ...
                        placeholder="Describe las reglas, el premio..."
                        placeholderTextColor={colors.textSecondaryDark}
                        multiline
                        numberOfLines={4}
