            ...
            >
                ...
                <View style={styles.profileHeader}>
                    ...
                    <Text style={styles.memberSince}>
                        Miembro desde {profile?.created_at ? new Date(profile.created_at).toLocaleDateString('es-ES', { month: 'short', year: 'numeric' }) : 'Feb 2023'}
                    </Text>
                    <View style={styles.levelBadge}>
                        <Text style={styles.levelBadgeText}>
                            Nivel {skillLevelLabel[profile?.skill_level || 'intermedio']}
                        </Text>
                    </View>
                </View>
                        ...
                        {(profile?.favorite_sports || ['padel', 'futbol']).map((sport, index) => {
                            ...
                            return (
                                <Chip
                                    ...
                                    icon={sportOption?.icon || 'football'}
                                    selected={index === 0}
                                    size="md"
                                />
                            );
                    ...
                    <View style={styles.zoneCard}>
                        ...
                        <View style={styles.notificationRow}>
                            ...
                            <Switch
                                ...
                                thumbColor={colors.textPrimaryDark}
                            />
                        </View>
                    </View>
                </View>
